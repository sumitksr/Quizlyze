...
export async function generateFlashcards(file, youtubeUrl, textContent, manualTranscript, numCards = 15) {
  try {
    // Get raw content
    const contentData = await fetchContent(file, youtubeUrl, textContent, manualTranscript);
